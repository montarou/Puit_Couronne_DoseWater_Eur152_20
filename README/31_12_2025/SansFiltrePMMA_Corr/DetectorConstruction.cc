...
: G4VUserDetectorConstruction(),
  ...
  fRingWidth(5.0*mm),
  fPMMAThickness(5.0*mm),           // NOUVEAU : épaisseur PMMA
  fPMMARadius(25.0*mm),             // NOUVEAU : rayon PMMA
  fTungstenFoilThickness(20.0*um),  // NOUVEAU : épaisseur feuille W (20 µm)
  fTungstenFoilRadius(25.0*mm),     // NOUVEAU : rayon feuille W
...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    fPMMA = nist->FindOrBuildMaterial("G4_PLEXIGLASS");  // NOUVEAU : PMMA
    ...
    G4LogicalVolume* logicFilter = new G4LogicalVolume(solidFilter, air, "FilterLog");
    ...
    G4LogicalVolume* logicContainerWall = new G4LogicalVolume(solidContainerWall, air, "ContainerWallLog");   //  fW_PETG
    ...
    G4LogicalVolume* logicContainerTop = new G4LogicalVolume(solidContainerTop, air, "ContainerTopLog");   //fW_PETG
    ...
    // =============================================================================
    // NOUVEAU : TRANCHE PMMA (5 mm) AVANT LE PRECONTAINERPLANE
    // Position : juste avant PreContainerPlane (qui est à GAP=0 de l'eau)
    // =============================================================================

    G4double pmmaTopZ = waterBottomZ - fCountingPlaneThickness;  // Haut du PMMA = bas du PreContainerPlane
    ...
    G4LogicalVolume* logicPMMA = new G4LogicalVolume(solidPMMA, air , "PMMALog"); //fPMMA
    ...
    for (G4int i = 0; i < kNbWaterRings; ++i) {
        ...
        G4LogicalVolume* logicRing = new G4LogicalVolume(solidRing, air , ringName + "Log");
        logicRing->SetUserLimits(waterLimits);  //fWater
    ...
    // =============================================================================
    // NOUVEAU : FEUILLE DE TUNGSTÈNE (20 µm) APRÈS L'EAU
    // Position : entre l'eau et le PostContainerPlane
    // =============================================================================

    G4double tungstenFoilBottomZ = waterTopZ;  // Bas de la feuille = haut de l'eau
    ...
    G4VisAttributes* tungstenFoilVis = new G4VisAttributes(G4Colour(0.3, 0.3, 0.3, 0.9));  // Gris foncé
    ...
    G4cout << "\n╔═════════════════════════════════════════════════════════╗" << G4endl;
    G4cout << "║           NOUVEAU : FEUILLE DE TUNGSTÈNE                  ║" << G4endl;
    G4cout << "╠═══════════════════════════════════════════════════════════╣" << G4endl;
    ...
    // ─────────────────────────────────────────────────────────────────────────────
    // PLAN POST-CONTAINER - Violet - DANS L'EAU - Matériau AIR
    // Limite haute = surface basse de la feuille de tungstène (tungstenFoilBottomZ)
    // Le plan chevauche l'eau pour capter le backscatter du W
    // ─────────────────────────────────────────────────────────────────────────────
    G4double postContainerPlane_z = tungstenFoilBottomZ - fCountingPlaneThickness/2;  // Limite haute = bas du W

    // Plan de comptage en AIR (chevauche l'eau)
    ...
    G4LogicalVolume* logicPostContainerPlane = new G4LogicalVolume(solidPostContainerPlane, air, "PostContainerPlaneLog");
    ...
    G4cout << "\n╔══════════════════════════════════════════════════════════════╗" << G4endl;
    G4cout << "║        GÉOMÉTRIE : PUITS COURONNE (MODIFIÉE)                   ║" << G4endl;
    G4cout << "╠════════════════════════════════════════════════════════════════╣" << G4endl;
    G4cout << "║                                                                ║" << G4endl;
    ...
    G4cout << "║                                                                ║" << G4endl;
    G4cout << "╟────────────────────────────────────────────────────────────────╢" << G4endl;
    G4cout << "║  NOUVEAU - TRANCHE PMMA (fenêtre d'entrée) :                   ║" << G4endl;
    G4cout << "║    Épaisseur : " << fPMMAThickness/mm << " mm                  ║" << G4endl;
    G4cout << "║    Rayon : " << fPMMARadius/mm << " mm                         ║" << G4endl;
    G4cout << "║    Z bas : " << pmmaBottomZ/mm << " mm                         ║" << G4endl;
    G4cout << "║    Z haut : " << pmmaTopZ/mm << " mm                           ║" << G4endl;
    G4cout << "║    Masse : " << pmmaMass/g << " g                              ║" << G4endl;
    G4cout << "║                                                                ║" << G4endl;
    G4cout << "╟────────────────────────────────────────────────────────────────╢" << G4endl;
    ...
    G4cout << "║                                                                ║" << G4endl;
    G4cout << "╟────────────────────────────────────────────────────────────────╢" << G4endl;
    G4cout << "║  NOUVEAU - FEUILLE TUNGSTÈNE (absorbeur électrons) :           ║" << G4endl;
    G4cout << "║    Épaisseur : " << fTungstenFoilThickness/um << " µm          ║" << G4endl;
    G4cout << "║    Rayon : " << fTungstenFoilRadius/mm << " mm                 ║" << G4endl;
    G4cout << "║    Z bas : " << tungstenFoilBottomZ/mm << " mm                 ║" << G4endl;
    G4cout << "║    Z haut : " << tungstenFoilTopZ/mm << " mm                   ║" << G4endl;
    G4cout << "║    Masse : " << tungstenFoilMass/mg << " mg                    ║" << G4endl;
    G4cout << "║                                                                ║" << G4endl;
    G4cout << "╟────────────────────────────────────────────────────────────────╢" << G4endl;
    ...
    G4cout << "║PostContainer(violet,AIR):z="<<postContainerPlane_z/mm <<"mm ║" << G4endl;
    G4cout << "║ -> Limite haute="<<tungstenFoilBottomZ/mm<<"mm (bas feuille W)   ║" << G4endl;
    G4cout << "║ -> CHEVAUCHE L'EAU (capte backscatter du W)                   ║" << G4endl;
    G4cout << "║                                                                ║" << G4endl;
    G4cout << "╟────────────────────────────────────────────────────────────────╢" << G4endl;
    ...
    G4cout << "║                                                                ║" << G4endl;
    G4cout << "╟────────────────────────────────────────────────────────────────╢" << G4endl;
    G4cout << "║EMPILEMENT (direction +z, depuis source) :                      ║" << G4endl;
    G4cout << "║ 1. PMMA : " << pmmaBottomZ/mm << " - " << pmmaTopZ/mm << " mm  ║" << G4endl;
    G4cout << "║ 2. PreContainer:"<<(preContainerPlane_z-fCountingPlaneThickness/2)/mm << " - " <<(preContainerPlane_z + fCountingPlaneThickness/2)/mm << " mm              ║" << G4endl;
    G4cout << "║ 3. EAU            : " << waterBottomZ/mm << " - " << waterTopZ/mm << " mm                      ║" << G4endl;
    G4cout << "║ 4. PostContainer  : " << (postContainerPlane_z - fCountingPlaneThickness/2)/mm << " - " << (postContainerPlane_z + fCountingPlaneThickness/2)/mm << " mm (DANS EAU)   ║" << G4endl;
    G4cout << "║ 5. Feuille W      : " << tungstenFoilBottomZ/mm << " - " << tungstenFoilTopZ/mm << " mm                   ║" << G4endl;
    G4cout << "║                                                                ║" << G4endl;
    G4cout << "╚═══════════════════════════════════════════════════════════════╝\n" << G4endl;
