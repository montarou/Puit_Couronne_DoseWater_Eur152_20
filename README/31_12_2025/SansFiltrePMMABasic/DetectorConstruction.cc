...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    G4LogicalVolume* logicTungstenFoil = new G4LogicalVolume(solidTungstenFoil, air , "TungstenFoilLog");  //fTungsten
    ...
    // ─────────────────────────────────────────────────────────────────────────────
    // PLAN POST-CONTAINER - Violet - GAP = 0 après feuille W - Matériau W_PETG
    // Limite basse = surface haute de la feuille de tungstène
    // ─────────────────────────────────────────────────────────────────────────────
    G4double postContainerPlane_z = tungstenFoilTopZ + fCountingPlaneThickness/2;  // GAP = 0 après W
    ...
    G4cout << "║ -> Limite basse="<<tungstenFoilTopZ/mm<<"mm (haut feuille W)   ║" << G4endl;
    G4cout << "║                                                                ║" << G4endl;
    G4cout << "╟────────────────────────────────────────────────────────────────╢" << G4endl;
    ...
    G4cout << "║ 4. Feuille W      : " << tungstenFoilBottomZ/mm << " - " << tungstenFoilTopZ/mm << " mm                   ║" << G4endl;
    G4cout << "║ 5. PostContainer  : " << (postContainerPlane_z - fCountingPlaneThickness/2)/mm << " - " << (postContainerPlane_z + fCountingPlaneThickness/2)/mm << " mm          ║" << G4endl;
    G4cout << "║                                                                ║" << G4endl;
    G4cout << "╚═══════════════════════════════════════════════════════════════╝\n" << G4endl;
