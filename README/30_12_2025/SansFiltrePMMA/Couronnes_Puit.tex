...
\normalsize
\noindent \begin{mdframed}[backgroundcolor=orange!20]
\subsection{\color{blue}\textbf{Insertion d'une plaque de PMMA et d'une feuille de W pour améliorer le build-up dans l'eau}\color{black}}
\end{mdframed}
\footnotesize
%===============================================================================
\medskip
...
\normalsize
\noindent \color{blue}\textbf{Vue en coupe de la géométrie}\color{black}
\footnotesize
\smallskip
    \medskip
\noindent La figure suivante présente une vue en coupe axiale (plan XZ) de la géométrie du container et des plans de comptage associés.
