...
\hline
\footnotesize \color{headerblue}\textbf{3}\color{black} &  texttt{nTransmitted}&\footnotesize Int&\footnotesize Nombre de gammas transmis à travers le filtre \\
\hline
...
\hline
\footnotesize \color{headerblue}\textbf{6}\color{black} & \texttt{nSecondaries}&\footnotesize Int&\footnotesize Nombre de particules secondaires détectées \\
\hline
...
\normalsize
\noindent \begin{mdframed}[backgroundcolor=orange!20]
\subsection{\color{blue}\textbf{Résultats}\color{black}}
\end{mdframed}
\footnotesize
%===============================================================================
\medskip
