...
\medskip
\noindent \color{blue}\textbf{Synthèse de la comparaison Air vs Tungstène}\color{black}
\begin{table}[h]
\centering
\captionsetup{labelformat=empty}
...
\captionsetup{labelformat=empty}
\caption{\textbf{Photons (panneaux supérieurs)}\newline 
...
\captionsetup{labelformat=empty}
\caption{${\rm \; \; \; \; }$ \textbf{-} \; \textbf{Perte de photons} : $(1.129 - 1.000) / 1.129 = 11.4\%$ (vs 11.1\% sans PMMA)\newline
...
\captionsetup{labelformat=empty}
\caption{${\rm \; \; \; \; }$ \textbf{-} \; Pic de fluorescence X du tungstène toujours dominant à \textbf{60--80~keV}\newline
...
\captionsetup{labelformat=empty}
\caption{${\rm \; \; \; \; }$ \textbf{-} \;  Spectre très différent de la configuration sans PMMA\newline
...
\captionsetup{labelformat=empty}
\caption{${\rm \; \; \; \; }$ \textbf{-} \; Distribution plus large : jusqu'à $N_{e^-} = 8$ (vs 7 sans PMMA)\newline
...
\captionsetup{labelformat=empty}
\caption{Spectre très différent de la configuration sans PMMA\newline
${\rm \; \; \; \; }$ \textbf{-} \;  Forme en ``bosse'' avec pic à $\sim$500~keV\newline
${\rm \; \; \; \; }$ \textbf{-} \;  Queue jusqu'à $\sim$1500~keV (électrons Compton de haute énergie)\newline
${\rm \; \; \; \; }$ \textbf{-} \;  Entries : 99\,092 (vs 9\,973 sans PMMA) $\rightarrow$ facteur $\times 10$}
\end{figure}
...
\normalsize
\noindent \begin{mdframed}[backgroundcolor=orange!20]
\subsection{\color{blue}\textbf{Résultats avec la configuration compléte (eau+Tungstene+PMMA}\color{black}}
\end{mdframed}
\footnotesize
%===============================================================================
\medskip
