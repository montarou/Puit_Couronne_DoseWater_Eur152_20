...
public:
    ...
    // ═══════════════════════════════════════════════════════════════
    // STRUCTURES POUR LES DONNÉES DES PLANS DU CONTAINER
    // ═══════════════════════════════════════════════════════════════
    ...
    // Enregistrement des données des plans du container (par événement)
    void RecordPreContainerPlaneData(const PreContainerPlaneData& data);
    void RecordPostContainerPlaneData(const PostContainerPlaneData& data);
    
    // ═══════════════════════════════════════════════════════════════
    // COMPTEURS DE PASSAGE (noms complets)
    // ═══════════════════════════════════════════════════════════════
    
    void IncrementGammasEnteringFilter() { fGammasEnteringFilter++; }
    void IncrementGammasExitingFilter() { fGammasExitingFilter++; }
    void IncrementGammasEnteringContainer() { fGammasEnteringContainer++; }
    void IncrementGammasEnteringWater() { fGammasEnteringWater++; }
    void IncrementElectronsInWater() { fElectronsInWater++; }
    void IncrementGammasPreFilterPlane() { fGammasPreFilterPlane++; }
    void IncrementGammasPostFilterPlane() { fGammasPostFilterPlane++; }
    void IncrementGammasPreContainerPlane() { fGammasPreContainerPlane++; }
    void IncrementGammasPostContainerPlane() { fGammasPostContainerPlane++; }
    void IncrementGammasPreWaterPlane() { fGammasPreWaterPlane++; }
    void IncrementGammasPostWaterPlane() { fGammasPostWaterPlane++; }
    
    // ═══════════════════════════════════════════════════════════════
    // COMPTEURS DE PASSAGE (alias pour compatibilité SteppingAction)
    // ═══════════════════════════════════════════════════════════════
...
private:
    ...
    G4int fGammasPreWaterPlane;
    G4int fGammasPostWaterPlane;
