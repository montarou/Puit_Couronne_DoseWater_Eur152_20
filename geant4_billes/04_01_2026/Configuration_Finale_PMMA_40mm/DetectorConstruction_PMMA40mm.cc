...
: G4VUserDetectorConstruction(),
  ...
  fRingWidth(5.0*mm),
  fPMMAThickness(40.0*mm),           // MODIFIÉ : épaisseur PMMA (5 mm -> 40 mm)
...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    G4LogicalVolume* logicContainerTop = new G4LogicalVolume(solidContainerTop, fW_PETG, "ContainerTopLog");   //fW_PETG
    ...
    G4LogicalVolume* logicPMMA = new G4LogicalVolume(solidPMMA, fPMMA , "PMMALog"); //air
    ...
    G4LogicalVolume* logicTungstenFoil = new G4LogicalVolume(solidTungstenFoil, fTungsten , "TungstenFoilLog");  //air
    ...
    // ─────────────────────────────────────────────────────────────────────────────
    // PLAN POST-CONTAINER - Violet - DANS L'EAU
